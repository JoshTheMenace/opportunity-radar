...
// Run: pnpm tsx src/lib/engine/retrieve.smoke.ts

import { getDb, INSERT_OPPORTUNITY_SQL, opportunityToRow } from "../db";
import type { CompanyProfile, Opportunity } from "../types";
import { retrieveCandidates, getOpportunityById, countBySource } from "./retrieve";

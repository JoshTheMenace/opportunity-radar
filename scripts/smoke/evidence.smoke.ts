...
//   pnpm tsx scripts/smoke/evidence.smoke.ts               -> cache-only (no network)
//   RUN_NETWORK=1 pnpm tsx scripts/smoke/evidence.smoke.ts -> live API calls
...
import { getEvidence, evidenceCacheKeys } from "../../src/lib/engine/evidence";

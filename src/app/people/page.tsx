...
export const metadata: Metadata = {
  title: "Utah Funding Connections",
  ...
  if (!company) {
    return (
      <main className="mx-auto w-full max-w-3xl space-y-4 px-4 py-10 sm:px-6">
        <p className="text-xs font-semibold uppercase tracking-wide text-brand">Utah Funding Connections</p>
        <h1 className="font-display text-3xl font-bold tracking-tight text-ink">Start with your company profile.</h1>
        <p className="text-sm leading-relaxed text-muted">This focused directory connects a saved company with public Utah navigators and documented Utah grant and federal-contract precedents. It never implies an endorsement or promised introduction.</p>

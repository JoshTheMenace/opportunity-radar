...
// Run: pnpm tsx scripts/smoke/rank.smoke.ts
...
import type { CompanyProfile, GatedOpportunity, Opportunity } from "../../src/lib/types";
import { rankOpportunities, tierFor } from "../../src/lib/engine/rank";
